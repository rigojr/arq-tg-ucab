...
peer channel fetch 0 $UCAB_CHANNEL_BLOCK -o $ORDERER_ADDRESS -c ucabchannel --tls --cafile /vagrant/ucab/tls/crypto-config/ordererOrganizations/ucabor.ucab.edu.ve/tlsca/tlsca.ucabor.ucab.edu.ve-cert.pem

# Join the channel
peer channel join -o $ORDERER_ADDRESS -b $UCAB_CHANNEL_BLOCK --tls --cafile /vagrant/ucab/tls/crypto-config/ordererOrganizations/ucabor.ucab.edu.ve/tlsca/tlsca.ucabor.ucab.edu.ve-cert.pem
